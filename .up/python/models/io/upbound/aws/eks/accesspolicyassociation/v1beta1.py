...
class ForProvider(BaseModel):
    ...
    principalArnRef: Optional[PrincipalArnRef] = None
    """
    Reference to a AccessEntry in eks to populate principalArn.
    """
    principalArnSelector: Optional[PrincipalArnSelector] = None
    """
...
class AtProvider(BaseModel):
    accessScope: Optional[AccessScope] = None
    associatedAt: Optional[str] = None
    clusterName: Optional[str] = None
...
class AccessPolicyAssociation(BaseModel):
    ...
    """
    kind: Optional[str] = 'AccessPolicyAssociation'
    """
