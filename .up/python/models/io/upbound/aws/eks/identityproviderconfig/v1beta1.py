...
#   filename:  workdir/eks_aws_upbound_io_v1beta1_identityproviderconfig.yaml
...
class IdentityProviderConfig(BaseModel):
    ...
    """
    kind: Optional[str] = 'IdentityProviderConfig'
    """
...
class IdentityProviderConfigList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[IdentityProviderConfig]
    """
    List of identityproviderconfigs. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
